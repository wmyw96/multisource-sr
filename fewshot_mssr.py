...
idx2name = {}
name2idx = {}
for i in range(len(params['data']['train'])):
...
#n_sources = 1
#if n_sources != 1:
#    raise Exception, "Only Few Shot to One Domain"
...
for ep in range(begin_ep, params['train']['num_episodes']):
    ...
    fetches = sess.run(targets['train_local'][source], feed_dict=feed_dict)
